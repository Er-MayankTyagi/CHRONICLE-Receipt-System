...
$qry = " INSERT INTO `rcv` (`name`, `reg_num`,`course`, `depositer`, `date` , `rcv_no`, `particulars`, `fee_month`) VALUES ('$name','$reg_num','$course','$depositer','$date', '$rcv_no','$particulars','$month')";
...
<table border="">
	...
	<tr>
		...
		course:<b><?php echo $_POST['course'];?></b>
