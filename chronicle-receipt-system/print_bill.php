...
?><center>
    <div align="center">
        ...
        <body style="height: 147mm; width: 102mm; margin-top: 10px; margin-left: 8px;">
            <table border="">
                <tr>
                    <td style="text-align:center; border-width: 0px;" colspan="4"><b style="font-size: 20px;">Indian
                            Convent School<br> <small>AN ENGLISH MEDIUM ON CBSE PATTERN</small> <br>
                            Punwarka ,Janta Road (Sahranpur)
                        </b></td>
                </tr>
                <tr>
                    <td colspan="2" style="border-width: px;" rowspan="2">Student Name: <b
                            style="text-transform: uppercase; text-align: right;"><?php echo "" . $_POST['name'] . " / " . $_POST['reg_num']; ?></b><br>
                ...
                <tr>
                    ...
                    <td><?php echo $total = $amount + 250 * $no_of_month; ?>/-</td>
                    <td align="right"></td>
                </tr>
                <?php
